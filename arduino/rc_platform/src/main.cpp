...
const int MOTOR_L_EN_PIN  = 8;
const int MOTOR_R_EN_PIN  = 7;
const int MOTOR_R_HIGH_PIN = 9;
const int MOTOR_R_LOW_PIN  = 10;
const int MOTOR_L_HIGH_PIN = 12;
const int MOTOR_L_LOW_PIN  = 11;
...
//     last_enc_time = now;
//     // handler->update();
//     robot->update_v_w_command(500, 0);
...
// float pwm = 45;
// float left_wheel_pwm = pwm;
// float right_wheel_pwm = pwm;
